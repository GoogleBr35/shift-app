...
export const ShiftDetailModal = ({ staffName, shifts, onClose }: ShiftDetailModalProps) => {
    return (
        ...
        >
            <div
                className="bg-white rounded-xl shadow-lg w-full max-w-xs mx-4 p-5"
                    ...
                    {shifts.map((s) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-base font-medium text-gray-800 w-10 text-right">
                                    {s.start}
                                </span>
                                <span className="text-gray-500">~</span>
                                <span className="text-base font-medium text-gray-800 w-10 text-left">
                                    {s.end}
                                </span>
                            </div>
                        </div>
